...
const ESG_HVAC = {'A+':{pct:32,$/sf:0.55},'A':{pct:24,$/sf:0.40},'B+':{pct:15,$/sf:0.25},'B':{pct:10,$/sf:0.16},'B-':{pct:5,$/sf:0.08},'C':{pct:0,$/sf:0}}
...
export default function Step4Solar({state,update,onNext,onBack}){
  ...
  const hvac = ESG_HVAC[facing.esg]||{pct:10,'$/sf':0.16}
  const orientationSaving = Math.round(totalSF * (hvac['$/sf'] || 0))
