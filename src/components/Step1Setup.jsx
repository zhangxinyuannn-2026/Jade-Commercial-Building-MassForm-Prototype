      ...
      <div className="intro-banner">
        <div className="intro-banner-left">
          ...
          <p className="intro-desc" style={{ marginTop: 8 }}>
            ...
            matters. MassForm draws on 15+ architecturally-grounded precedents from SOM, KPF, Foster + Partners,
            BIG, OMA, and Rogers Stirk Harbour to generate massing section diagrams that are buildable and
        ...
        <div className="intro-banner-right">
          {/* Section diagram illustration */}
          <div className="intro-section-diagram">
            {[
              { label:'CROWN',    color:'#e8c4a8', stroke:'#c07850', h:10 },
              { label:'AMENITY',  color:'#b4dfc4', stroke:'#4aaa74', h:8  },
              { label:'OFFICE',   color:'#b8d4e8', stroke:'#5a92b8', h:40 },
              { label:'TRADING',  color:'#ffc890', stroke:'#c08030', h:16 },
              { label:'LOBBY',    color:'#f7c97a', stroke:'#c8962e', h:12 },
            ].map(b => (
              <div key={b.label} className="intro-section-band"
                style={{ height:`${b.h}%`, background:b.color, borderTop:`1.5px solid ${b.stroke}` }}>
                <span style={{ fontSize:9, fontFamily:'var(--font-mono)', color:b.stroke, fontWeight:600, letterSpacing:'0.06em' }}>
                  {b.label}
                </span>
              </div>
            ))}
            <div className="intro-section-ground" />
            <div className="intro-section-label">SECTION</div>
          </div>
        </div>
      </div>
