...
import Step4Facade  from './components/Step5Facade.jsx'   // was Step5
import Step5Solar   from './components/Step4Solar.jsx'    // was Step4
...
const defaultState = {
  ...
  // Step 3
  massingType:'box', selectedMassingVariant:null,
  // Step 4 — Facade (now before solar)
  glassRatioN:0.30, glassRatioS:0.55, glassRatioE:0.45, glassRatioW:0.35,
  windowHeight:7, windowWidth:5, windowSpacing:3,
  glassType:'highPerf', wallType:'metalPanel',
  // Step 5 — Solar/ESG
  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-main">
        ...
        {step===4 && <Step4Facade  state={state} update={update} onNext={()=>setStep(5)} onBack={()=>setStep(3)} />}
        {step===5 && <Step5Solar   state={state} update={update} onNext={()=>setStep(6)} onBack={()=>setStep(4)} />}
